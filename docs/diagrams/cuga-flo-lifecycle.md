...
sequenceDiagram
    ...
    rect rgb(230, 240, 255)
        ...
        Note right of Reg: Services: register_flow(config_path)<br/>get_bpmn_process(key), get_flow_annotations(key)<br/>get_definition(key), list_keys()
        ...
        FA->>Reg: get_flow_annotations(process_key)
        Reg-->>FA: FlowConfig
